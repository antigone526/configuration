...
" Plugin taglist {
    ...
    let Tlist_Ctags_Cmd = 'd:\Vim\vimfiles\bundle\ctags\ctags.exe'   "set the ctags path
...
"GUI Settings{
        ...
        elseif WINDOWS() && has("gui_running")
            set guifont=Microsoft_YaHei_Mono:h12,Menlo:h12,Consolas:h12,Courier_New:h12
        endif
"}
...
"=======================================
" MiniBUfExpl settings Kevin She Added Settings
"=======================================
" MiniBufExpl {
...
"
"=======================================
" winmanager settings Kevin She Added Settings
"=======================================
" add NERDTree  and BufExplorer to winmanager {
    "let g:winManagerWindowLayout = "NERDTree|TagList"
    let g:winManagerWindowLayout = "TagList|FileExplorer,BufExplorer"
    nmap <leader>wm :WMToggle<CR>
" Kevin She added Setting, seting NerdTree in winManagerWindowLayout
